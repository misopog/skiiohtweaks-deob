...
@shift /0 
@ECHO OFF 
Title Skiioh Performance Booster 
chcp 65001 >NUL 
mode 1000 
color 5 
goto :warning 
...
echo. 
echo. 
echo.                                                                                                 Type numbers to select your options 
echo.    
echo.                                                                                  Please Read All warnings and dont just press buttons without reading 
echo. 
echo. 
...
echo. 
echo.                                                                                                                                      
echo.                                                                                  For All Questions: discord.gg/skii or DM @SkiiohTweaks on Twitter 
echo.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
echo.                                                                                                         [ 0 ] Pre-Optimization  
echo. 
echo.                                                                                  [ 1 ] FPS Tweaks                                 [ 2 ] GPU Tweaks                         
echo. 
echo. 
echo. 
echo. 
echo.  
echo.                                                                                  [ 3 ] Low Input Delay Tweaks                     [ 4 ] 0 PING TWEAKS 
echo.   
echo. 
echo. 
echo. 
echo. 
echo.                                                                                  [ 5 ] Ram Tweaks                                 [ 6 ] New Tweaks               
echo.   
echo. 
echo. 
echo.                                                                                             
...
echo.   
echo.   
set /p userinp= ^> What Would You like To Do?  
...
if %userinp%==0 goto :res 
if %userinp%==1 goto :win 
if %userinp%==2 goto :gpu 
if %userinp%==3 goto :usb 
if %userinp%==4 goto :net 
if %userinp%==5 goto :ram 
if %userinp%==6 goto :sec 
:res  
cls 
...
start explorer.exe 
start "" https://twitter.com/misopog
GoTo :menu 
:win 
cls 
cls 
...
REM ; TURN OFF Windows Cloud Search 
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\Windows Search" /v "AllowCloudSearch" /t REG_DWORD /d "0" /f 
REM ; TURN OFF Activity Recommendations 
REM ; TURN OFF My Device History 
Reg.exe add "HKCU\Software\Microsoft\Windows\CurrentVersion\Search" /v "DeviceHistoryEnabled" /t REG_DWORD /d "0" /f 
REM ;-----PRIVACY----- 
REM ; TURN OFF Let websites provide locally relevant content by accessing my language list 
Reg.exe add "HKCU\Control Panel\International\User Profile" /v "HttpAcceptLanguageOptOut" /t REG_DWORD /d "1" /f 
REM ; TURN OFF Let Windows track app launches to improve Start and search results 
...
REM ; TURN OFF Getting to know you 
...
REM ; SET Choose your default app mode 
Reg.exe add "HKCU\Software\Microsoft\Windows\CurrentVersion\Themes\Personalize" /v "AppsUseLightTheme" /t REG_DWORD /d "0" /f 
REM ; TURN OFF Show recently added apps 
...
REM ; TURN OFF Show recently opened items in Jump Lists on Start or the taskbar 
Reg.exe add "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v "Start_TrackDocs" /t REG_DWORD /d "0" /f 
REM ; TURN ON Always show all icons in the notification area 
Reg.exe add "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer" /v "EnableAutoTray" /t REG_DWORD /d "0" /f 
REM ; TURN OFF Turn system icons on or off - Action Center 
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows\Explorer" /v "DisableNotificationCenter" /t REG_DWORD /d "1" /f 
REM ;-----DEVICES----- 
REM ; TURN OFF Scroll inactive windows when i hover over them 
Reg.exe add "HKCU\Control Panel\Desktop" /v "MouseWheelRouting" /t REG_DWORD /d "0" /f 
REM ; TURN OFF Write in the handwriting panel with your fingertip 
Reg.exe add "HKCU\Software\Microsoft\TabletTip\1.7" /v "EnableInkingWithTouch" /t REG_DWORD /d "0" /f 
REM ; TURN OFF Show recommended app suggestions 
...
REM ;--------------------CONTROL-------------------- 
REM ;-----EASE OF ACCESS----- 
REM ; TURN OFF Ease Of Access settings 
...
REM ;-----APPERANCE AND PERSONALIZATION----- 
REM ; SET Open File Explorer to This PC 
Reg.exe add "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v "LaunchTo" /t REG_DWORD /d "1" /f 
REM ; TURN OFF Hide extentions for known file types 
Reg.exe add "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v "HideFileExt" /t REG_DWORD /d "0" /f 
REM ; TURN OFF Show frequently used folders in Quick access 
...
REM ; TURN OFF Turn on fast startup (recommended) 
...
REM ; TURN OFF Allow Remote Assistance connections to this computer 
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Remote Assistance" /v "fAllowToGetHelp" /t REG_DWORD /d "0" /f 
REM ; TURN OFF Automatic Maintenance 
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Schedule\Maintenance" /v "MaintenanceDisabled" /t REG_DWORD /d "1" /f 
REM ;--------------------OTHER-------------------- 
REM ; SET Menu show delay 
Reg.exe add "HKCU\Control Panel\Desktop" /v "MenuShowDelay" /t REG_SZ /d "0" /f 
REM ; SET Wallpaper quality 100% 
Reg.exe add "HKCU\Control Panel\Desktop" /v "JPEGImportQuality" /t REG_DWORD /d "256" /f 
REM ; TURN OFF Firefox updates 
...
:gpu 
cls 
@echo Type "Nvidia" If You Have A Nvidia GPU 
@echo Type "Amd" If You Have A AMD GPU 
SET /P choice= _ 
IF /I "%choice%"=="Nvidia" goto Nvidia 
...
nvidiaProfileInspector.exe "C:\Windows\Base_Profile.nip" 
cd C:\Windows 
del /f Base_Profile.nip 
cd\ 
start "" https://twitter.com/misopog
lmao 
GoTo Menu 
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\amdlog" /v "Start" /t REG_DWORD /d "4" /f > nul 
start "" https://twitter.com/misopog
GoTo Menu 
:usb 
cls 
curl https://cdn.discordapp.com/attachments/1035435552847183872/1165393552973512815/Skiioh.pow -o "%HOMEPATH%\AppData\Local\Temp\Skiioh.pow" 
powercfg -import "%HOMEPATH%\AppData\Local\Temp\Skiioh.pow" 1b933c57-3389-4661-b5d3-d9bb693bab48 
...
@echo off reg add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v FeatureSettingsOverride /t REG_DWORD /d 3 /f reg add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v FeatureSettingsOverrideMask /t REG_DWORD /d 3 /f 
start "" https://twitter.com/misopog
GoTo :menu 
:net 
cls 
...
SET msgboxBody=The Service Has Been Installed And Activated Successfully! 
...
TITLE Success! 
SET msgboxTitle=Success! 
SET msgboxBody=The Service Was Enabled Successfully! 
SET tmpmsgbox=%temp%\~tmpmsgbox.vbs 
IF EXIST "%tmpmsgbox%" DEL /F /Q "%tmpmsgbox%" 
ECHO msgbox "%msgboxBody%",0,"%msgboxTitle%">"%tmpmsgbox%" 
WSCRIPT "%tmpmsgbox%" 
...
ren smartscreen.exe smartscreen.exe.old 
ren RuntimeBroker.exe RuntimeBroker.exe.old 
chdir /d C:\Windows\SystemApps\Microsoft.Windows.Cortana_cw5n1h2txyewy 
ren SearchUI.exe SearchUI.exe.old 
chdir /d C:\Windows\SystemApps\Microsoft.Windows.StartMenuExperienceHost_cw5n1h2txyewy 
ren StartMenuExperienceHost.exe StartMenuExperienceHost.exe.old 
chdir /d C:\Windows\SystemApps\ShellExperienceHost_cw5n1h2txyewy 
ren ShellExperienceHost.exe ShellExperienceHost.exe.old 
chdir /d C:\Program Files\WindowsApps\Microsoft.YourPhone_1.22112.142.0_x64__8wekyb3d8bbwe 
ren PhoneExperienceHost.exe PhoneExperienceHost.exe.old 
chdir /d C:\Windows\System32 
ren CompPkgSrv.exe CompPkgSrv.exe.old 
ren GameBarPresenceWriter.exe GameBarPresenceWriter.old.exe 
cls 
@echo Debloating your WINDOWS of useless stuff! 
cls 
cls 
...
cls 
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Winmgmt" /v "Start" /t REG_DWORD /d "4" /f 
